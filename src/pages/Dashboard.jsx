  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-6 py-10">
        ...
        <p className="text-gray-500 text-sm mb-8">Here's your activity this month.</p>
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 text-sm text-blue-700 mt-4">
          Your AI finds <strong>{profile?.plan === 'premium' ? '20' : profile?.plan === 'standard' ? '5' : '2'} new matching jobs every day</strong>. Check your applications tab daily for new matches and cover letters, then apply with one click.
        </div>

        {pct >= 80 && profile?.plan !== 'premium' && (
          <div className="bg-violet-50 border border-violet-200 rounded-xl p-4 text-sm text-violet-800 mb-4 mt-4">
        ...
        <div className="bg-white border rounded-xl p-5 mt-4">
          <div className="font-medium text-gray-900 mb-1">Need more credits?</div>
        ...
        <div className="grid grid-cols-2 gap-4 mt-6">
          ...
          <button onClick={() => navigate('/applications')} className="bg-white border rounded-xl p-5 text-left hover:border-violet-300 transition">
            ...
            <div className="text-sm text-gray-500">Browse your found jobs and apply</div>
          </button>
        </div>
      </div>
    </div>
