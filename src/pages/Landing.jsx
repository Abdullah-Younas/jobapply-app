  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto text-center px-6 py-24">
        ...
        <p className="text-xl text-gray-500 mb-10">Our AI finds jobs that match your skills, writes personalized cover letters and sends applications automatically. Only applies to jobs where you match 70% or more of requirements.</p>
        <button 
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-3 gap-8">
          {[
            ...
            { step: '3', title: 'Applications ready', desc: 'Personalized cover letters written and ready for you to apply with one click.' },
          ].map(item => (
